...
export default {
  ...
  computed: {
    ...
    summary() {
      return this.BacksideI + this.BacksideII + this.AbsI + this.AbsII;
    },
    checked() {
  ...
  created() {
    this.gridData = generateGrids('Backside-I', 'Abs & Backside');
  },
  activated() {
    window.scrollTo(0, 0);
  },
  ...
  methods: {
    ...
    changeTab(tabItem) {
      ...
      this.gridData = generateGrids(tabItem.name, 'Abs & Backside');
    },
    changeScore(e) {
    ...
    formStatus(accordionName) {
      return this.patient['Abs & Backside'][accordionName].weight !== 0
      && this.patient['Abs & Backside'][accordionName].reps !== 0
      && this.patient['Abs & Backside'][accordionName].sets !== 0
