...
export default {
  ...
  computed: {
    ...
    // symptomscore: {
    //   get() {
    //     if (this.area[this.$attrs.body].SymptomScore.Erythema === '0') {
    //       return this.selected;
    //     }
    //     return this.area[this.$attrs.body].SymptomScore.Erythema;
    //   },
    //   set(val) {
    //     this.selected = true;
    //     this.$store.commit(
    //        'setSymptomScore',
    //        { body: this.$attrs.body, symptom: 'Erythema', val }
    //     );
    //   },
    // },
  },
  watch: {
    selected() {
      this.$store.commit('setSymptomCompleted', { body: this.$attrs.body, symptom: 'ERYTHEMA', completed: true });
      this.$store.commit('checkSymptomCompleted', { body: this.$attrs.body });
    },
  },
  created() {
    this.grids = generateGrids('Erythema', 'Head & Neck');
  },
  methods: {
    ...
    triggerComputed(gridScore) {
      this.selected = true;
      this.$store.commit('setSymptomScore', { body: this.$attrs.body, symptom: 'Erythema', val: gridScore });
    },
  },
};
</script>
...
<template>
    <div>
        ...
        <div class="grid-one desktop">
            <div :key="grid.name" class="grid" v-for="grid in grids">
                <div class="imgbox">
                    <div
                        class="img"
