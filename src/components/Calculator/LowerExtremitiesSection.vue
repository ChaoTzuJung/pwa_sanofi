...
import LegFrontImage from 'assets/images/leg-front.svg';
import LegBackImage from 'assets/images/leg-back.svg';
...
export default {
  ...
  activated() {
    console.log('[LOWER] activated');
    window.scrollTo(0, 0);
  },
  deactivated() {
    console.log('[LOWER] deactivated');
    const lowerData = {
  ...
  <div class="head-neck-section">
    <div class="graph-section">
      <div class="front">
        ...
        <img :src="LegFrontImage" />
      </div>
      <div class="back">
        <div class="title">Back</div>
        <img :src="LegBackImage" />
      </div>
    </div>
